...
5. **Логирование:** весь ход PoC — в `specs/US-3-admin-ux-redesign/be4-poc-blocks-report.md` (создаётся в день 2). Для каждого PoC: пройден / не пройден / комментарий.
...
Файл `specs/US-3-admin-ux-redesign/be4-poc-blocks-report.md` с секциями:
