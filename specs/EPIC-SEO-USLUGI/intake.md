...
2026-05-08 · US-2 closed: 4 newui HTML (6479 строк) + ba/sa-seo/leadqa-2/RC, leadqa Playwright MCP 16/16 screenshots × axe-core 0 critical × 4 templates, RC 25/25 PASS, PR #184 → main `2726204` auto-merge after CI 3/3 green. phase: done. → готов dispatch US-3 (Payload расширение: Districts +23, ServiceDistricts bulk-seed 150, namespace validate-hooks, lint:slug CI gate, uniquenessScore beforeValidate)
2026-05-08 · US-3 closed: collections (+reviewedBy +validate-hooks ADR-0019) + 2 миграции + 4 seed-scripts + uniqueness helper + uborka-territorii pillar (id=11) seed. DB: districts 31 (30 target + 1 sustained dup `zhukovsky`), service_districts 154 (5 pillar × 31 — over by 4 sustained legacy), все noindexUntilCase=true. lint:slug 0 collisions, type-check 0, leadqa-3 PASS 14/14. Sustained ADR-0014 PAYLOAD_DISABLE_PUSH=1 для seed. Conditional follow-up US-7: zhukovsky→zhukovskij 301 redirect.
```
