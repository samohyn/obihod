...
**Source of truth:** `design-system/brand-guide.html` §12 «Паблик → Payload» + [`specs/US-12-admin-redesign/art-concept-v2.md`](../US-12-admin-redesign/art-concept-v2.md)
...
- Spec: `specs/US-12-admin-redesign/art-concept-v2.md` (полная концепция от art)
- Brief: `specs/US-12-admin-redesign/art-brief-ui.md` (от art→ui→fe1+be4)
