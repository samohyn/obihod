...
Проект запуска сайта **«Обиход»** — комплексный подрядчик 4-в-1 (вывоз мусора +
арбористика + чистка крыш от снега + демонтаж) для Москвы и МО. B2C (частные дома,
дачи) + B2B (УК, ТСЖ, FM-операторы, застройщики, госзаказ).

> **Порядок 4 услуг = порядок pillar в IA сайта.** Утверждён оператором
