...
reports_to: poshop
handoffs_from: [poshop, fe-shop, be-shop, qa-shop]
handoffs_to: [poshop, release]
consults: [tamd, sa-shop, do]
...
- **security-review** — OWASP top 10, секреты, валидация, XSS, SQLi, CSRF, SSRF, безопасность платежей и PII покупателей.
