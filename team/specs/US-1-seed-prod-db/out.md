...
- → **`po`** — написать release notes `team/release-notes/US-1-seed-prod-db.md` (шаблон WORKFLOW §8), завести 7 follow-up Issues (§9), перевести OBI-<N> в Done после post-seed verification.
