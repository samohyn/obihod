...
5. **Логирование:** весь ход PoC — в `team/specs/US-3-admin-ux-redesign/be4-poc-blocks-report.md` (создаётся в день 2). Для каждого PoC: пройден / не пройден / комментарий.
...
Файл `team/specs/US-3-admin-ux-redesign/be4-poc-blocks-report.md` с секциями:
