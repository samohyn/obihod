...
| `team/ops/migrations/us-3-blocks-up.sql` | Копия up-SQL для ревью (не executable) | 19 KB |
| `team/ops/migrations/us-3-blocks-down.sql` | Копия down-SQL для ревью | 1.5 KB |
