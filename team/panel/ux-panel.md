...
reports_to: art
handoffs_from: [art, popanel]
handoffs_to: [ui, art, popanel]
...
- **click-path-audit** — трассировка действий администратора в панели (логин → задача → результат).
