...
**Автор:** dba
**Дата:** 2026-04-23
**Входы:** `./ba.md`, `./sa.md`, `./intake.md`, `devteam/adr/ADR-0002-site-chrome-dedup-seosettings.md` (Accepted, с оговоркой про ручной `pg_dump`), `site/globals/SeoSettings.ts`, `site/payload.config.ts`, `.claude/memory/handoff.md`.
