...
**Автор:** dba
**Дата:** 2026-04-23
**Входы:** `./ba.md`, `./sa.md`, `./intake.md`, `devteam/adr/ADR-0001-seed-prod-runner.md` (Accepted), `site/scripts/seed.ts`, `site/collections/{Services,Districts,ServiceDistricts,Cases,Persons}.ts`, `site/payload.config.ts`, `.claude/memory/handoff.md`.
...
3. QA-отчёт копирует лог seed (stdout) в `devteam/specs/US-1-seed-prod-db/qa.md` — совпадает с DoD ADR-0001 и sa §8.
