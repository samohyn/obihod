...
```
devteam/specs/US-12-admin-redesign/
...
Связанные:
- [`devteam/specs/admin-visual/art-concept.md`](../admin-visual/art-concept.md) — v1 (не переделывать).
- [`devteam/specs/US-3-admin-ux-redesign/`](../US-3-admin-ux-redesign/) — старые ux-wireframes / ui-mockups / be4-fields-checklist (re-use где можно).
