...
- Tone — Caregiver+Ruler с акцентом Ruler (договор, тариф, отчётность). НЕ «индивидуальный подход для бизнеса», НЕ «гибкие условия».
...
- Lead-form helper: «1 рабочий день» — конкретно. НЕ «свяжемся в кратчайшие сроки».
