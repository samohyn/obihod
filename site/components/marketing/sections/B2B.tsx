      ...
      <div className="wrap">
        <div className="section-head">
          <div>
            ...
            <h2 className="h-xl">
              УК, посёлки,<br />застройщики.
            </h2>
          </div>
          <p className="section-sub">
            Два B2B-направления с&nbsp;отдельными договорами, отсрочкой оплаты и&nbsp;закреплённым менеджером.
            Коммерческие условия — индивидуально, KPI — в&nbsp;SLA.
          </p>
        </div>
        ...
        <div className="b2b-grid">
          <div className="b2b-card">
            ...
            <div className="b2b-desc">
              Один договор на&nbsp;всё: уборка снега, арбо, вывоз мусора, мелкий демонтаж.
              Один менеджер, один ежемесячный счёт, ноль срывов собраний жителей.
            </div>
