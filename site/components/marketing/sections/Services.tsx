    ...
    <section className="hp-section alt">
      <div className="wrap">
        ...
        <h2 style={{ maxWidth: '22ch' }}>
          Один подрядчик — все хозяйственные работы на участке
        </h2>
        <p className="lead">
          Не нужно искать арбориста, кровельщика, мусоровоз и демонтажника по отдельности.
          Бригада, техника, смета и договор — у одного оператора.
        </p>
        ...
        <div className="hp-pillars">
          ...
          <Link href="/chistka-krysh" className="hp-pillar" style={{ textDecoration: 'none' }}>
            ...
            <h3>Чистка крыш</h3>
            <p>
              От снега и наледи, сбивание сосулек, промальп, автовышка. С оформлением акта по
              форме.
            </p>
            <div className="price">
              <div>
          ...
          <Link href="/vyvoz-musora" className="hp-pillar" style={{ textDecoration: 'none' }}>
            ...
            <h3>Вывоз мусора</h3>
            <p>
              Контейнеры 7-30 м³, газель, старая мебель, строительный мусор, садовый,
              крупногабарит.
            </p>
            <div className="price">
              <div>
          ...
          <Link href="/demontazh" className="hp-pillar" style={{ textDecoration: 'none' }}>
            ...
            <h3>Демонтаж</h3>
            <p>
              Снос дома, бани, сарая, внутренний демонтаж под ремонт. Утилизация и вывоз отходов
              в одном договоре.
            </p>
            <div className="price">
              <div>
