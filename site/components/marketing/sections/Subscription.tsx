      ...
      <div className="wrap">
        <div className="section-head">
          <div>
            ...
            <h2 className="h-xl">
              Заплатили раз в&nbsp;год —<br />забыли об&nbsp;участке.
            </h2>
          </div>
          <p className="section-sub">
            Три годовых пакета для частных хозяев. Все сезонные работы, документы
            и&nbsp;выезды по&nbsp;звонку — под одним договором, без повторных согласований.
          </p>
        </div>
