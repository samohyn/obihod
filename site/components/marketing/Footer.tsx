        ...
        <div className="foot-grid">
          <div className="foot-brand">
            ...
            <div className="foot-slogan">
              Один подрядчик на&nbsp;весь год: спил, снег, демонтаж, вывоз.
              <br />
          ...
          <div className="foot-col">
            ...
            <ul>
              <li>
                <a href="#services">Спил деревьев</a>
              </li>
              <li>
                <a href="#services">Уборка снега</a>
              </li>
              <li>
                <a href="#services">Демонтаж и снос</a>
              </li>
              <li>
                <a href="#services">Вывоз мусора</a>
              </li>
              <li>
          ...
          <div className="foot-col">
            ...
            <ul>
              ...
              <li>
                <a href="mailto:hello@obihod.ru">hello@obihod.ru</a>
              </li>
              <li>
                <a href="#">Telegram @obihod</a>
              </li>
              <li>
                <a href="#">ВКонтакте</a>
              </li>
