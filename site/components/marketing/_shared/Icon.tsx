...
export const Icon = {
  Tree: ({ size = 20, ...p }: IconProps) => (
    <svg viewBox="0 0 24 24" {...base(size, 20)} fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...p}>
      <path d="M12 2 L5 11 L9 11 L4 18 L10 18 L10 22 L14 22 L14 18 L20 18 L15 11 L19 11 Z" />
    </svg>
  ),
  Snow: ({ size = 20, ...p }: IconProps) => (
    <svg viewBox="0 0 24 24" {...base(size, 20)} fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" aria-hidden="true" {...p}>
  ...
  Phone: ({ size = 18, ...p }: IconProps) => (
    <svg viewBox="0 0 24 24" {...base(size, 18)} fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...p}>
      <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
    </svg>
  ),
  Plus: ({ size = 20, ...p }: IconProps) => (
    <svg viewBox="0 0 24 24" {...base(size, 20)} fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" aria-hidden="true" {...p}>
      <line x1="12" y1="5" x2="12" y2="19" />
      <line x1="5" y1="12" x2="19" y2="12" />
    </svg>
  ),
  Check: ({ size = 18, ...p }: IconProps) => (
    <svg viewBox="0 0 24 24" {...base(size, 18)} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...p}>
  ...
  Phone2: ({ size = 22, ...p }: IconProps) => (
    <svg viewBox="0 0 24 24" {...base(size, 22)} fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...p}>
