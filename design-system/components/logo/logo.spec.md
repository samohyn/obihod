...
- **2026-04-23 · v0.1 draft** — временное решение «wordmark без символа + монограмма О» в admin (см. [specs/admin-visual/art-concept.md](../../../specs/admin-visual/art-concept.md)). Оставалось до утверждения финального знака.
